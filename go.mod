...
require github.com/argoproj-labs/argocd-operator v0.0.0-00010101000000-000000000000

replace github.com/argoproj-labs/argocd-operator => github.com/akhilnittala/argocd-operator v0.0.0-20250925153600-749b72cf823a
